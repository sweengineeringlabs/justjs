...
- No composition with `<view-badge>` in v1 (unlike
  `<control-provider-connect>`) — some headers show a provider badge next
...
Unlike `<control-provider-connect>` (tied 1:1 to a screen), this header
...
- [ADR-0007](ADR-0007-connect-kit-control.md)
