// counter — browser E2E test (auto-generated)
// Source: styles/counter_component.yaml (v1)
// Run:    justw test src/features/counter/counter_e2e_test.gen.ts --browser --e2e
//
...
console.log('1. Counter root element renders');
page.waitForSelector('x-counter');
const root = page.querySelector('x-counter');
assert(root !== null, 'Counter root <x-counter> must exist in DOM');

console.log('2. Counter element content is reachable');
