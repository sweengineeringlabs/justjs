// login — native integration test (auto-generated)
// Source: styles/login_component.yaml (v1)
// Run:    justw test src/features/login/login_int_test.gen.ts --native
//
// DO NOT EDIT — regenerate with: justw generate component login
...
import { LoginBase } from './login_component.gen';
...
test('login_module_exports_LoginBase_class', () => {
  assert(typeof LoginBase === 'function', 'LoginBase must be exported as a class/constructor');
});

test('login_tag_name_is_a_valid_custom_element_name', () => {
  const tag: string = LoginBase.tagName;
  assert(typeof tag === 'string' && tag.length > 0, 'LoginBase.tagName must be a non-empty string');
