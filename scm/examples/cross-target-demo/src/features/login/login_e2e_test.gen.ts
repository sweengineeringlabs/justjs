// login — browser E2E test (auto-generated)
// Source: styles/login_component.yaml (v1)
// Run:    justw test src/features/login/login_e2e_test.gen.ts --browser --e2e
//
...
console.log('1. Login root element renders');
page.waitForSelector('x-login');
const root = page.querySelector('x-login');
assert(root !== null, 'Login root <x-login> must exist in DOM');

console.log('2. Login element content is reachable');
