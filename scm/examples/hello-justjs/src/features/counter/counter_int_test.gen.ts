// counter — native integration test (auto-generated)
// Source: styles/counter_component.yaml (v1)
// Run:    justw test src/features/counter/counter_int_test.gen.ts --native
//
// DO NOT EDIT — regenerate with: justw generate component counter
...
import { CounterBase } from './counter_component.gen';
...
test('counter_module_exports_CounterBase_class', () => {
  assert(typeof CounterBase === 'function', 'CounterBase must be exported as a class/constructor');
});

test('counter_tag_name_is_a_valid_custom_element_name', () => {
  const tag: string = CounterBase.tagName;
  assert(typeof tag === 'string' && tag.length > 0, 'CounterBase.tagName must be a non-empty string');
