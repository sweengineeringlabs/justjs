// fetch-demo — native integration test (auto-generated)
// Source: styles/fetch-demo_component.yaml (v1)
// Run:    justw test src/features/fetch-demo/fetch_demo_int_test.gen.ts --native
//
// DO NOT EDIT — regenerate with: justw generate component fetch-demo
...
import { FetchDemoBase } from './fetch_demo_component.gen';
...
test('fetch-demo_module_exports_FetchDemoBase_class', () => {
  assert(typeof FetchDemoBase === 'function', 'FetchDemoBase must be exported as a class/constructor');
});

test('fetch-demo_tag_name_is_a_valid_custom_element_name', () => {
  const tag: string = FetchDemoBase.tagName;
  assert(typeof tag === 'string' && tag.length > 0, 'FetchDemoBase.tagName must be a non-empty string');
