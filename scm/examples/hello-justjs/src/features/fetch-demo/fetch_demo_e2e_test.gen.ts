// fetch-demo — browser E2E test (auto-generated)
// Source: styles/fetch-demo_component.yaml (v1)
// Run:    justw test src/features/fetch-demo/fetch_demo_e2e_test.gen.ts --browser --e2e
//
...
console.log('1. FetchDemo root element renders');
page.waitForSelector('x-fetch');
const root = page.querySelector('x-fetch');
assert(root !== null, 'FetchDemo root <x-fetch> must exist in DOM');

console.log('2. FetchDemo element content is reachable');
