// connect — browser test (auto-generated)
// Source: connect_component.yaml (v1)
// Run:    justw test connect_browser_test.gen.ts --browser
//
...
try {
  ...
  page.waitForSelector('x-connect');

  console.log('1. Connect root element renders');
  const root = page.querySelector('x-connect');
  assert(root !== null, 'Connect root <x-connect> must exist in DOM');

  console.log('2. Connect element content is reachable');
