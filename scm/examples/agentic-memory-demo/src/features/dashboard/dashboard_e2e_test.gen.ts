// dashboard — browser E2E test (auto-generated)
// Source: styles/dashboard_component.yaml (v1)
// Run:    justw test src/features/dashboard/dashboard_e2e_test.gen.ts --browser --e2e
//
...
console.log('1. Dashboard root element renders');
page.waitForSelector('x-dashboard');
const root = page.querySelector('x-dashboard');
assert(root !== null, 'Dashboard root <x-dashboard> must exist in DOM');

console.log('2. Dashboard element content is reachable');
