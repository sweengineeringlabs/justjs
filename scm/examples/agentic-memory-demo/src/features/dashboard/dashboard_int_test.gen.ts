// dashboard — native integration test (auto-generated)
// Source: styles/dashboard_component.yaml (v1)
// Run:    justw test src/features/dashboard/dashboard_int_test.gen.ts --native
//
// DO NOT EDIT — regenerate with: justw generate component dashboard
...
import { DashboardBase } from './dashboard_component.gen';
...
test('dashboard_module_exports_DashboardBase_class', () => {
  assert(typeof DashboardBase === 'function', 'DashboardBase must be exported as a class/constructor');
});

test('dashboard_tag_name_is_a_valid_custom_element_name', () => {
  const tag: string = DashboardBase.tagName;
  assert(typeof tag === 'string' && tag.length > 0, 'DashboardBase.tagName must be a non-empty string');
