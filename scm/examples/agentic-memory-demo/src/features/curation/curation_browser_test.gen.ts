// curation — browser test (auto-generated)
// Source: curation_component.yaml (v1)
// Run:    justw test curation_browser_test.gen.ts --browser
//
...
try {
  ...
  page.waitForSelector('x-curation');

  console.log('1. Curation root element renders');
  const root = page.querySelector('x-curation');
  assert(root !== null, 'Curation root <x-curation> must exist in DOM');

  console.log('2. Curation element content is reachable');
